...
<form class="myform" id="msform" action="min.php">
  <!-- fieldsets -->
  <fieldset>
	...
	<input class="barcode" type="text" name="no_id" placeholder="Barcode ID" id="no_id" onkeyup="checkAvailability()"/>
	<span id="user-availability-status"></span>
	<input class="qty" type="text" name="kurang" placeholder="Quantity" id="kurang" pattern="[0-9]{1,}"/>
