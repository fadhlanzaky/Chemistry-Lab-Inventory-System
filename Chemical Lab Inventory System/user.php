...
<head><xml>
    ...
    <title>User || Chemistry Lab Inventory System</title>
...
<section id="section03" class="demo">
  ...
  <div id="wrap" class="wrap">
		  ...
		  <?php 
			...
			$result->execute();
				...
				echo "<option data-value='detail_user.php?no_id={$row['no_id']}' value= {$row['name']}></option>";
				endforeach;
			?>
			<Script>
				function searchmat(){
  ...
  <div class="leftt">
    <div class="text">Add User</div><button class='but'>User</button>
  </div>
  <div class="center">
...
<!-----Isi tabel-------->
	...
	$result->execute();
		...
		$answ->execute();
		echo "<tr><td>&nbsp;".$row['no_id']."<br> ". $row['2nd_id']."</td><td><a href='detail_user.php?no_id={$row['no_id']}';'>".$row['name']."</a></td><td>";while ($ansexp = $ans -> fetch()){echo $ansexp['exp_date'],"<br>";}; echo "</td><td>";while ($ansexp = $answ -> fetch()){echo $ansexp['stock'],"<br>";};echo "</td><td>".$row['last_stock']."</td><td>".$row['percentage']."</td></tr>";
		endforeach;
